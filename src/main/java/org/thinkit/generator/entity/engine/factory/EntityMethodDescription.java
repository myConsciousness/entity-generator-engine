...
/**
 * エンティティクラスのメソッドJavadocを生成する処理を定義したファクトリークラスです。
 *
 * @author Kato Shinya
 * @since 1.0.0
 */
...
public class EntityMethodDescription extends FunctionDescription {

    /**
     * 引数として渡された情報を基に {@link EntityMethodDescription} クラスの新しいインスタンスを生成します。
     *
     * @param description 説明
     *
     * @exception NullPointerException 引数として {@code null} が渡された場合
     */
    private EntityMethodDescription(@NonNull String description) {
        super(description);
    }

    /**
     * 引数として渡された情報を基に {@link EntityMethodDescription} クラスの新しいインスタンスを生成し返却します。
     *
     * @param description 説明
     * @return {@link EntityMethodDescription} クラスの新しいインスタンス
     *
     * @exception NullPointerException 引数として {@code null} が渡された場合
     */
    protected static FunctionDescription of(@NonNull String description) {
        return new EntityMethodDescription(description);
    }
