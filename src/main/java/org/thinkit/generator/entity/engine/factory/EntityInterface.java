...
/**
 * エンティティクラスのインターフェースを生成する処理を定義したファクトリークラスです。
 *
 * @author Kato Shinya
 * @since 1.0.0
 */
...
public final class EntityInterface extends Interface {

    /**
     * 引数として渡された情報を基に {@link EntityInterface} クラスの新しいインスタンスを生成します。
     *
     * @param literal インターフェース名
     *
     * @exception NullPointerException 引数として {@code null} が渡された場合
     */
    private EntityInterface(@NonNull String literal) {
        super(literal);
    }
     ...
     * @exception NullPointerException 引数として {@code null} が渡された場合
     */
    private EntityInterface(@NonNull String literal, @NonNull Generics generics) {
        super(literal, generics);
    }

    /**
     * 引数として渡された情報を基に {@link EntityInterface} クラスの新しいインスタンスを生成し返却します。
     *
     * @param literal インターフェース名
     * @return {@link EntityInterface} クラスの新しいインスタンス
     *
     * @exception NullPointerException 引数として {@code null} が渡された場合
     */
    protected static Interface of(@NonNull String literal) {
        return new EntityInterface(literal);
    }
    ...
    protected static Interface of(@NonNull String literal, @NonNull Generics generics) {
        return new EntityInterface(literal, generics);
    }
